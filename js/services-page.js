exports.default = function () {
  ...
  const checkedValue = serviceSlider.querySelector("input:checked").value;
  ...
  sliderInfoSlides[checkedValue - 1].setAttribute("data-current", true);
  gsap.set(sliderInfoSlides[checkedValue - 1], { autoAlpha: 1 });
