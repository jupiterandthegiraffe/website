...
const pages = {
  ...
  "end-credits": require("./end-credits").default,
  "process-page": require("./process-page").default,
  "home-page": require("./home-page").default,
  "merry-christmas": require("./merry-christmas").default,
};
