...
if ( ! function_exists( 'jupiter_and_the_giraffe_enqueue_scripts' ) ) :
    ...
    wp_enqueue_script( 'pgia', get_template_directory_uri() . '/pgia/lib/pgia.js', null, '1.0.1694', true );

    wp_enqueue_script( 'split_text', get_template_directory_uri() . '/libs/SplitText.js', null, '1.0.1694', true );

    wp_register_script( 'main_javascript', null, array( 'split_text' ), '1.0.1694', true );
    ...
    wp_register_script( 'inline-script-1', '', [], '1.0.1694', false );
    ...
    wp_enqueue_script( 'jupiter_and_the_giraffe-chartumd', 'https://cdn.jsdelivr.net/npm/chart.js@4.5.0/dist/chart.umd.min.js', [], '1.0.1694', true);

    wp_deregister_script( 'jupiter_and_the_giraffe-app' );
    wp_enqueue_script( 'jupiter_and_the_giraffe-app', get_template_directory_uri() . '/scripts/app.js', [], '1.0.1694', true);

    /* Pinegrow generated Enqueue Scripts End */

        /* Pinegrow generated Enqueue Styles Begin */

    wp_enqueue_style( 'theme_styles', get_template_directory_uri() . '/css/theme.css', null, '1.0.1694', 'all' );

    wp_enqueue_style( 'main_styles', get_template_directory_uri() . '/css/style.css', null, '1.0.1694', 'all' );

    wp_enqueue_style( 'font_styles', get_template_directory_uri() . '/wp-content/uploads/yabe-webfont/cache/fonts.css', null, '1.0.1694', 'all' );

    wp_deregister_style( 'jupiter_and_the_giraffe-theme' );
    wp_enqueue_style( 'jupiter_and_the_giraffe-theme', get_template_directory_uri() . '/css/theme.css', [], '1.0.1694', 'all');

    wp_deregister_style( 'jupiter_and_the_giraffe-aiassesment' );
    wp_enqueue_style( 'jupiter_and_the_giraffe-aiassesment', get_template_directory_uri() . '/css/ai-assesment.css', [], '1.0.1694', 'all');

    wp_deregister_style( 'jupiter_and_the_giraffe-style' );
    wp_enqueue_style( 'jupiter_and_the_giraffe-style', get_bloginfo('stylesheet_url'), [], '1.0.1694', 'all');
