...
<div class="container page-container" id="service">
    <section style="margin-bottom: 100px">
        <img src="<?php echo get_template_directory_uri(); ?>/wp-content/uploads/2024/09/blog-thumbnail.jpg" class="post-featured-image"/>
        <h1><?php the_title(); ?></h1>
